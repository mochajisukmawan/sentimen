										...
										<li class="dropdown">
											...
											<div class="ripple-container"></div></a>
												<ul class="dropdown-menu dropdown-menu-right" style="background-color: #5a8fd6;">
														...
														<li class="active"><a href="input_data_new.php">Input Data</a></li>
                        ...
                        <div class="card-content table-responsive">
                          <div class="tab-content">
        					                ...
        					                if(isset($msg)){
      							           ...
      							           ?>
      											  <p>Inputkan file training dalam format (*.csv)</p>
                                ...
                                <div class="col-sm-4">
                                  ...
                                  <input type="submit" name="upload_data_training" class="btn btn-info" value="Simpan">
      										...
      										<div class="tab-pane" id="input-data-testing">
      											<p>Inputkan file testing dalam format (*.csv)</p>
      											<form method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
      												<div class="col-sm-4">
